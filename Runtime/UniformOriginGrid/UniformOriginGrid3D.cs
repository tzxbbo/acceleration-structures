...
{
    public struct UniformOriginGrid3D
    {
        ...
        public UniformOriginGrid3D(float halfExtents, int subdivisions)
        {
            Subdivisions = subdivisions;
            HalfExtents = halfExtents;

            CellCount = (int)math.pow(8, subdivisions);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsInBounds(in UniformOriginGrid3D grid, float3 position)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int3 GetCellCoordsFromPosition(in UniformOriginGrid3D grid, float3 position)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int3 GetCellCoordsFromIndex(in UniformOriginGrid3D grid, int index)
        {
            return new int3
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int GetCellIndex(in UniformOriginGrid3D grid, float3 position)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int GetCellIndexFromCoords(in UniformOriginGrid3D grid, int3 coords)
        {
            return (coords.x) +
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool GetAABBMinMaxCoords(in UniformOriginGrid3D grid, float3 aabbMin, float3 aabbMax, out int3 minCoords, out int3 maxCoords)
        {
